  ...
  <div>
      ...
      <div class="flex-1 menu-pc">
        ...
        <div class="flex bg-green-800 h-14 rounded-bl-full items-center justify-between p-2 pl-10">
          ...
          <div class="flex items-center gap-2">
            ...
            <text class="text-white">Consultation Hotline</text>
          </div>
          <!-- 在线咨询 -->
          <UButton
        ...
        <div class="flex gap-5 justify-between w-full pr-4 t">
          <div class="flex items-center justify-center gap-10 flex-1 pl-10">
            <div
              class="flex h-16 justify-center text-lg items-center relative"
              v-for="(item, index) in navList"
              :key="index"
              @mouseover="showChildren(index)"
              @mouseout="hideChildren(index)"
            >
          ...
          <div class="flex items-center justify-center gap-2">
            <input type="text" placeholder="Search" class="border-gray-300 border p-2 rounded-full" v-model="search" />
            <UIcon
              name="i-heroicons-magnifying-glass"
              class="w-6 h-6 text-gray-500 cursor-pointer hover:text-yellow-500"
              @click="handleSearch"
            />
          </div>
        </div>
    ...
    <Transition name="mobile-menu">
      <div v-if="isMobileMenuOpen" class="fixed inset-0 bg-black/50 z-50 lg:hidden" @click="closeMobileMenu">
        <div
          class="fixed top-0 right-0 h-full w-80 bg-white shadow-xl transform transition-all duration-300 ease-out"
          :class="{
          ...
          <div class="p-4">
            ...
            <nav class="space-y-2">
              <div v-for="(item, index) in navList" :key="index" class="border-b border-gray-100">
                ...
                <!-- 手机版子菜单 -->
                <div v-if="item.children.length > 0 && openMobileSubmenus.includes(index)" class="ml-4 mt-2 space-y-1">
                  <NuxtLink
    ...
    <footer>
        ...
        <div class="mx-auto py-4 lg:py-12 px-4 lg:px-8 flex-media gap-8 lg:gap-16">
          ...
          <form class="flex flex-col gap-2 flex-1" @submit.prevent="handleFormSubmit">
            ...
            <input
              ...
              maxlength="140"
              class="border-gray-300 border p-2 mb-2 rounded"
              required
            />
            ...
            <textarea
              ...
              class="border-gray-300 border w-full h-40 p-2 mb-2 rounded"
              required
            ></textarea>
            <button
              type="submit"
      ...
      <div class="bg-green-800 text-white text-center py-10 text-sm">
        ...
        <div class="text-xs">
          YUNZHU is a leading release agent manufacturer in China,specializing in custom-designed mold release solutions
